                    ...
                    <div class="col-xl-12 col-xxl-12 mb-5 mb-xxl-12">
                      ...
                      <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px h-xl-100 border-0 bg-gray-200" style="background-position: 100% 100%;background-size: 300px auto;">
                        ...
                        <div class="col-md-12 d-flex flex_pos my-2">
                            <h3 class="col-md-7 text-center my-1 mx-3 heading">Applications List</h3>
                            <form method="post" action="<?php echo base_url(); ?>Admin/application_list" class="col-md-5 d-flex mx-2">
                        ...
                        <div class="col-md-12 d-flex flex_pos">
                             ...
                             <a href="<?php echo base_url(); ?>Admin/application_list" class="btn btn-light mx-1 border-1 border border-dark btn_top"><i class="fa fa-refresh mx-1"></i><span class="txt">Refresh</span></a>
